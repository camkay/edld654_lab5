...
show_best(dt_tune_fit, metric = "rmse", n = 1) #rmse = 94.9
show_best(dt_tune_fit, metric = "rsq", n = 1) #rsq = .349
show_best(dt_tune_fit, metric = "huber_loss", n = 1) #huber loss = 72.4
```
...
show_best(bag_tune_fit, "rmse", n = 1) #rmse = 89
show_best(bag_tune_fit, "rsq", n = 1) #rsq = .407
show_best(bag_tune_fit, "huber_loss", n = 1) #huber loss = 69
```
